...
export function LoginPage() {
  ...
  return (
    ...
    <div className="flex bg-white">
      <section className=" login-mockup">
      ...
      <section className=" section-login" style={{ backgroundColor: "#1a1a2b" }}>
        <form onSubmit={handleSubmit(onSubmit)} style={{ width: "70%" }}>
          <div className="border-b-2 border-blue-500 mr-10 ml-10 h-14 mb-5 flex justify-center items-center uppercase">
            ...
            <h3 className="text-white text-center text-2xl upperxase">Iniciar Sesión</h3>
          </div>
          <div className="img-login-hmeqo">
            <img className="img-login-hotel-meqo" src={logo} atl="Logo del hotel meqo"/>
          </div>
