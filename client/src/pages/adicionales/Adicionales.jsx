...
const Adicionales = () => {
    ...
    const guardarRecepcion = async (bebida) => {
        try {
            const response = await AxiosInstances.post(`/pasadia-agregar-item-recepcion/${id}`, {
                bebida,
            });
    ...
    const handleCrearDescorche = async (descorche) => {
        try {
            await AxiosInstances.post(`/pasadia-agregar-descorche/${id}`, { descorche })
            limpiarDescorches();
    ...
    const guardarItem = async (food) => {
        try {
            await AxiosInstances.post(`/pasadia-agregar-food-subproducto/${id}`, {
                food,
            });
    ...
    const guardarFood = async (food) => {
        ...
        try {
            const response = await AxiosInstances.post(`/pasadia-agregar-food/${id}`, {
                food,
            });
            toast.success('Comida guardada exitosamente!');
