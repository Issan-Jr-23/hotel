...
import {
  ...
  useDisclosure,
  Select,
  SelectItem, Checkbox, Popover, PopoverTrigger, PopoverContent, Tabs, Tab
            ...
            {datosFiltrados.slice(start, end).map((cliente) => (
              ...
              <TableRow className="cursor-pointer hover:bg-blue-200" key={cliente._id}>
                ...
                <TableCell>
                  ...
                  {selectedUser && (
                    <Modal open={openTd} onClose={handleCloseTd}
                    >
                      <Box sx={styleAdd} style={{
                        ...
                        <Typography className="border-b-3 border-blue-500 text-3xl flex  justify-between">
                        ...
                        <Typography className="uppercase flex">
                                ...
                                <aside className="search-button">
                                  <div className="container">
                                    ...
                                    <input
                                      ...
                                      onChange={(e) => {// También detiene la propagación aquí para mayor seguridad
